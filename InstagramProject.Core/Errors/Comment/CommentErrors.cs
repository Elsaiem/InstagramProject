...
namespace InstagramProject.Core.Errors.Comment
{
	public static class CommentErrors
	{
		...
		public static readonly Error UnauthorizedAccess = new("Comment.UnauthorizedAccess", "You are not authorized to Delete this comment", StatusCodes.Status403Forbidden);
