...
namespace InstagramProject.Core.Service_contract
{
	...
	{
		Task<Result<UserDetailsResponse>> GetUserDetailsAsync(string userName, string currentuserName, CancellationToken cancellationToken = default);
		...
		Task<Result> HandleFollowActionAsync(string userId, AddFollowRequest request, CancellationToken cancellationToken = default);
        ...
        // Task<OperationResult> AddUserFollowAsync(AddFollowRequest response, CancellationToken cancellationToken = default);
         Task<OperationResult> DeleteUserFollowAsync(UnFollowRequest response, CancellationToken cancellationToken = default);
       ...
       // Task<Result> SendFollowRequestAsync(SendFollowRequestRequest request, CancellationToken cancellationToken = default);
        Task<Result> AcceptFollowRequestAsync(AddFollowRequest request, CancellationToken cancellationToken = default);
        Task<Result> RejectFollowRequestAsync(AddFollowRequest request, CancellationToken cancellationToken = default);
