...
namespace InstagramProject.Service.Services.Profile
{
	public class ProfileService : IProfileService
	{
		...
		public ProfileService(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IFileService fileService, IHttpContextAccessor httpContextAccessor, ApplicationDbContext context, IUnitOfWork unitOfWork, IServiceProvider serviceProvider)
		{
